...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo site_url('member/dashboard');?>" class="brand-link">
      <img src="<?php echo base_url();?>assets/image/logo.png" alt="AdminLTE Logo" class="" width="200px" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url();?>assets/cm/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('member/dashboard');?>" class="nav-link <?php  if($segment == 'dashboard'){ echo 'active';}?>">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('member/subscription');?>" class="nav-link <?php  if($segment == 'subscription'){ echo 'active';}?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Subscription
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/member/logout');?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                logout
              </p>
